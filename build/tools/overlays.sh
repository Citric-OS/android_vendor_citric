...
cur_dir=`pwd`
flashable_zip_template="$ANDROID_BUILD_TOP/vendor/citric/build/tools/overlays_zip_template"
overlays_path_top="$ANDROID_BUILD_TOP/vendor/citric/overlay/themes/"
overlays_path_temp="$ANDROID_BUILD_TOP/overlays_temp"
overlays_zip_name="citric_overlays.zip"
