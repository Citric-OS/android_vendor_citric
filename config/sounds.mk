...
# Copyright (C) 2018-2021 CitricOS
#
...
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,vendor/citric/sounds/pixel/,$(TARGET_COPY_OUT_PRODUCT)/media/audio)

# 2019 Material product sounds (CC-BY 4.0)
# Source: https://material.io/design/sound/sound-resources.html
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,vendor/citric/sounds/material/,$(TARGET_COPY_OUT_PRODUCT)/media/audio)
